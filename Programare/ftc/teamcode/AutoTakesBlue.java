...
@Autonomous(name = "AutoTakesBlue", group = "Sensor")

public class AutoTakesBlue extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            telemetry.addData("Takes:",Takes);
                while(RunTime.milliseconds() <= 29999)
                {
    ...
    {
        right_front.setPower(-.4);
        right_back.setPower(-.4);
        left_front.setPower(.4);
        left_back.setPower(.4);
    }
   ...
   /* private void DriveLeft()
    {
        right_front.setPower(.63);
        right_back.setPower(-.53);
        left_front.setPower(.70);
